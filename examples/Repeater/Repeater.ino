...
void setup() {
  ...
  Cresta::SensorReceiver::init(0, retransmit);    
}
...
void retransmit(byte *data) {  
  ...
  Cresta::SensorTransmitter::sendPackage(TRANSMITTER_PIN, data);

  digitalWrite(LED_PIN, LOW);

  noInterrupts();
  Cresta::SensorReceiver::enable();     
}
